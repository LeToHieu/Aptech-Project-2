...
public class UserListController {
    ...
    @FXML private void onAdd() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/aptech/aptechproject2/fxml/user_add.fxml"));
    ...
    @FXML private void onEdit() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/aptech/aptechproject2/fxml/user_edit.fxml"));
            Scene scene = new Scene(loader.load());
